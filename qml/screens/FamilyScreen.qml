...
Item {
    ...
    Popup {
        ...
        Column {
            ...
            Rectangle { width: parent.width-48; height: 46; radius: 12; anchors.horizontalCenter: parent.horizontalCenter; color: Qt.rgba(1,1,1,0.10); border.color: Qt.rgba(1,1,1,0.25); border.width: 1; TextField { id: nameIn; anchors.fill: parent; leftPadding: 14; rightPadding: 14; color: "white"; font.pixelSize: 15; placeholderText: "Имя"; background: null } }
            Rectangle { width: parent.width-48; height: 46; radius: 12; anchors.horizontalCenter: parent.horizontalCenter; color: Qt.rgba(1,1,1,0.10); border.color: Qt.rgba(1,1,1,0.25); border.width: 1; TextField { id: pinIn; anchors.fill: parent; leftPadding: 14; rightPadding: 14; color: "white"; font.pixelSize: 15; echoMode: TextField.Password; inputMethodHints: Qt.ImhDigitsOnly; maximumLength: 4; placeholderText: "PIN (необязательно)"; background: null } }
