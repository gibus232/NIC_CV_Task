...
Item {
    ...
    ListView {
        id: budgetList
        anchors.top: monthRow.bottom; anchors.topMargin: 12; anchors.bottom: parent.bottom; anchors.bottomMargin: 8; anchors.left: parent.left; anchors.leftMargin: 16; anchors.right: parent.right; anchors.rightMargin: 16
    ...
    Popup {
        ...
        background: Rectangle {
            ...
            Rectangle { anchors.top: parent.top; anchors.left: parent.left; anchors.right: parent.right; anchors.margins: 1; height: 48; radius: parent.radius; gradient: Gradient { GradientStop { position: 0.0; color: Qt.rgba(1,1,1,0.12) }
        ...
        Column {
            ...
            Rectangle {
                ...
                TextInput { id: amtIn; anchors.fill: parent; anchors.leftMargin: 14; anchors.rightMargin: 14; verticalAlignment: TextInput.AlignVCenter; color: "white"; font.pixelSize: 18; text: "0"; inputMethodHints: Qt.ImhFormattedNumbersOnly }
            }
            ...
            Row {
                ...
                Rectangle { width: 100; height: 44; radius: 22; color: Qt.rgba(1,1,1,0.10); border.color: Qt.rgba(1,1,1,0.20); border.width: 1; Text { anchors.centerIn: parent; text: "Отмена"; color: "white"; font.pixelSize: 14 }
                        MouseArea { anchors.fill: parent; onClicked: setBudgetPopup.close() } }
                Rectangle {
